...
# Input
  ...
  # Tabella senatori e deputati da OpenPolis con indice produttività, ecc.
...
# Analisi
  ...
  # Come regola generale modifico i nomi delle liste aderenti e da dati.camera affinché coincidano con quelli di OP. In pochissimi casi (errori palesi) cambio il nome in OP
